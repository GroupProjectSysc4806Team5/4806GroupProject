...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.bookstore.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.bookstore.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.bookstore.domain.User.class.getName());
            createCache(cm, com.bookstore.domain.Authority.class.getName());
